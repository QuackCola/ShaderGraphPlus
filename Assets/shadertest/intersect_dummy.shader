...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float l_2 = g_flIntersectionSharpness;
		float l_3 = g_flBubbleAlphaMul;
		float l_4 = g_flMasterAlphaMul;
		float4 l_5 = g_vShieldColor;
		float l_6 = Intersection(l_0,i.vNormalWs,i.vTextureCoords.xy,l_1,l_2,l_3,l_4,g_tTexture_ps_0,l_5);
		
		m.Albedo = float3( l_6, l_6, l_6 );
		m.Opacity = 0;
		m.Roughness = 1;
		m.Metalness = 0;
		m.AmbientOcclusion = 1;
