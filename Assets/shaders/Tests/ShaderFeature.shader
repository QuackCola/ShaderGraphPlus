...
FEATURES
{
	...
	Feature( F_MYFEATURE, 0..1, "MyHeader" );
...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float3 MyFeatureSwitchResult_Ref0;
		#if ( S_MYFEATURE == SWITCH_TRUE )
		{
			float3 l_0 = float3( 1, 0, 1 );
		...
		float3 l_0 = MyFeatureSwitchResult_Ref0;
