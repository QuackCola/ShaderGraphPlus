...
PS
{
	...
	static float4 Shade( PixelInput i, Material m  )
	{
		...
		float3 indirectColor = 0;
		{
			...
			float l_2 = l_0.y;
			float l_3 = l_0.z;
			float l_4 = i.vPositionSs.w;
			float4 l_5 = float4( l_1, l_2, l_3, l_4 );
			float l_6 = ScreenSpaceAmbientOcclusion::Sample( l_5 );
			indirectColor = float3( l_6, l_6, l_6 );
			Albedo += indirectColor;
