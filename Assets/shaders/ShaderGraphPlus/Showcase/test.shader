...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_0 = PixelPlot( g_tTexture_ps_0,g_sSampler0,i.vTextureCoords.xy,float2( 64, 64 ),0.5 );
		float2 l_1 = i.vTextureCoords.xy * float2( 1, 1 );
		float2 l_2 = (l_1 + g_flTime * float2( -0.01, 0 ));
		float l_3 = 1.0f - VoronoiNoise( l_2, 2, 60 );
		float2 l_4 = (l_1 + g_flTime * float2( -0.01, 0 ));
		float l_5 = 1.0f - VoronoiNoise( l_4, 2, 83 );
		float l_6 = lerp( l_3, max( 0.0f, (l_3) - (l_5) ), 0.3 );
