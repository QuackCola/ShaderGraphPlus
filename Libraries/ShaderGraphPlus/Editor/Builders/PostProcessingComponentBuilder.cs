...
public sealed partial class PostProcessingComponentBuilder
{
    ...
    private StringBuilder m_StringBuilderAttribs;
    ...
    public PostProcessingComponentBuilder(PostProcessingComponentInfo postProcessingComponentInfo)
    {
        m_StringBuilderProps = new StringBuilder();
        m_StringBuilderAttribs = new StringBuilder();
        m_PostProcessingComponentInfo = postProcessingComponentInfo;
    }
    ...
    public StringBuilder AddBoolProperty(string paramName, string paramStringValue)
    {
        ...
        m_StringBuilderAttribs.AppendLine($"attributes.Set( \"{paramName.Remove(0, 3)}\", {paramName.Remove(0, 2)} );");
    ...
    public StringBuilder AddVector2Property(string type, string paramName, string paramStringValue)
    {
        ...
        Vector2 vec2 = (Vector2)Utils.Vectors.ParseVector(match.Groups[1].Value);
    ...
    public StringBuilder AddVector3Property(string type, string paramName, string paramStringValue)
    {
        ...
        Vector3 vec3 = (Vector3)Utils.Vectors.ParseVector(match.Groups[1].Value);
    ...
    public StringBuilder AddVector4Property(string type, string paramName, string paramStringValue)
    {
        ...
        Vector4 vec4 = (Vector4)Utils.Vectors.ParseVector(match.Groups[1].Value);
    ...
    {
        return m_StringBuilderAttribs.ToString();
    }
