...
PS
{
	...
	float g_flRowAmount < UiGroup( ",0/,0/0" ); Default1( 4 ); Range1( 1, 64 ); >;
	float g_flColumnAmount < UiGroup( ",0/,0/0" ); Default1( 4 ); Range1( 1, 64 ); >;
	float g_flSpeed < UiGroup( ",0/,0/0" ); Default1( 1 ); Range1( 0, 16 ); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float l_1 = g_flRowAmount;
		float l_2 = g_flColumnAmount;
		float l_3 = g_flSpeed;
