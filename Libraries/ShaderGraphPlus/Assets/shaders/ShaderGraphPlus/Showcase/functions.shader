...
PS
{
	...
	SamplerState g_sShrimpleSampler < Filter( ANISO ); AddressU( WRAP ); AddressV( WRAP ); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_0 = g_tTexture_ps_0.Sample( g_sShrimpleSampler,i.vTextureCoords.xy );
		float l_1 = MakeGreyscale( l_0 );
